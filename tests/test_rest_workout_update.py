...
def test_rest_update_workout__valid_workout_id(
    ...
    response = workout_put(workout_id=workout_id_user, workout_data=workout_dict)
...
def test_rest_update_workout__not_found_workout(workout_put, workout_dict, workout_id):
    workout = workout_dict
...
# @todo
def test_rest_update_workout__invalid_name(workout_put, workout_dict):
    pass
...
# @todo
def test_rest_update_workout__invalid_description(workout_put, workout_dict):
    pass
