...
def test_rest_add_workout__valid_user_id(
        workout_post, workout_dict, user_id):
...
def test_rest_add_workout__invalid_user(
        workout_post, workout_dict, user_id):
    workout = workout_dict
...
def test_rest_add_workout__not_found_user(
        workout_post, workout_dict, user_id):
    workout = workout_dict
    workout['user_id'] = user_id
    response = workout_post(workout_data=workout)
...
def test_rest_add_workout__invalid_empty_description(
        workout_post, workout_dict):
    workout = workout_dict
